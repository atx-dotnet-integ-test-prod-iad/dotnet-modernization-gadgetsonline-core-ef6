...
namespace GadgetsOnline.Models
{
    ...
    // Replaces the SQL Server provider that was previously set via app.config.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------
        // DateTime kind fix: ensures all DateTime values are treated as UTC
        // when persisting to PostgreSQL (which is strict about timestamp
        // kind unlike SQL Server).
        // -----------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Column names are all lowercase to match PostgreSQL conventions.
            // -----------------------------------------------------------------
