...
{
    /// <summary>
    /// EF6 PostgreSQL configuration class for GadgetsOnlineEntities.
    /// Registers Npgsql as the provider and sets the default connection factory.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // ---------------------------------------------------------------
            // Schema + column mappings for PostgreSQL (schema: gadgetsonline_dbo)
            // ---------------------------------------------------------------
