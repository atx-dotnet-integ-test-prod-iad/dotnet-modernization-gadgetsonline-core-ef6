...
namespace GadgetsOnline.Models
{
    ...
    /// Registered via [DbConfigurationType] so EF6 automatically picks it up
    /// without requiring any manual bootstrapping calls.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // ---------------------------------------------------------------
            // PostgreSQL schema + column name mappings (gadgetsonline_dbo)
            // ---------------------------------------------------------------
