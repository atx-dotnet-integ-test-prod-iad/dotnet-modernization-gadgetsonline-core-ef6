...
namespace GadgetsOnline.Models
{
    ...
    // Registered via [DbConfigurationType] attribute on the DbContext class below
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ------------------------------------------------------------------
        // DateTime UTC fix for Npgsql: ensure all DateTime values written to
        // PostgreSQL carry DateTimeKind.Utc, which Npgsql requires by default.
        // ------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Relationship: Category 1-to-many Products
            ...
            // Relationship: Cart many-to-1 Product
            ...
            // Relationship: Order 1-to-many OrderDetails
            ...
            // Relationship: OrderDetail many-to-1 Product
