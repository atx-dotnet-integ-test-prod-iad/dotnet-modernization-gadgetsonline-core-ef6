...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // Product: table mapping and column names
            {
            ...
            // Category: table mapping, column names, and relationships
            {
            ...
            // Cart: table mapping, column names, and relationships
            {
            ...
            // Order: table mapping, column names, and relationships
            {
            ...
            // OrderDetail: table mapping, column names, and relationships
            {
