...
namespace GadgetsOnline.Models
{
    ...
    // knows how to talk to PostgreSQL without requiring an App.config entry.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime UTC fix: normalises all DateTime values to UTC before they are
        // persisted, which is required by the Npgsql driver (timestamptz columns).
        // -----------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Relationship: Cart requires a Product
            ...
            // Relationship: OrderDetail requires a Product
