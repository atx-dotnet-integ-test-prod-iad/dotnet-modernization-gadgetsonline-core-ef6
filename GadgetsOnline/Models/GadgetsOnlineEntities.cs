...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // ---------------------------------------------------------------
            // Product — schema + column mappings
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // Category — schema + column mappings + relationships
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // Cart — schema + column mappings + relationships
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // Order — schema + column mappings + relationships
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // OrderDetail — schema + column mappings + relationships
            // ---------------------------------------------------------------
