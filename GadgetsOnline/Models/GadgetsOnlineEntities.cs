...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // Configure table and column mappings: Product
            ...
            // Configure table and column mappings: Category
            ...
            // Preserve relationship configuration
            category.HasMany(c => c.Products)
                .WithRequired(p => p.Category)
                .HasForeignKey(p => p.CategoryId);

            // Configure table and column mappings: Cart
            ...
            // Configure table and column mappings: Order
            ...
            // Configure table and column mappings: OrderDetail
