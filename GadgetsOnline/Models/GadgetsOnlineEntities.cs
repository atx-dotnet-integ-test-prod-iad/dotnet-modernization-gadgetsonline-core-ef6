...
namespace GadgetsOnline.Models
{
    ...
    // Registers the Npgsql provider services and default connection factory so
    // that Entity Framework 6 resolves the correct ADO.NET driver at runtime.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------
        // DateTime UTC compatibility helpers for PostgreSQL / Npgsql
        // Npgsql requires DateTime values to carry DateTimeKind.Utc
        // when writing to timestamp with time zone columns.
        // ---------------------------------------------------------
        ...
        {
            // ---------------------------------------------------------------
            // Table and column mappings — target schema: gadgetsonline_dbo
            ...
            // ---------------------------------------------------------------
            // Relationships — preserved exactly from original configuration
            // ---------------------------------------------------------------
