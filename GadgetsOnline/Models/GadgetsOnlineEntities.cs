...
namespace GadgetsOnline.Models
{
    ...
    // that EF6 uses PostgreSQL instead of SQL Server for this DbContext.
    // ---------------------------------------------------------------------------
    ...
    [System.Data.Entity.DbConfigurationType(
        typeof(GadgetsOnlineEntitiesPostgreSqlConfiguration))]
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ------------------------------------------------------------------
        // DateTime compatibility fix for Npgsql / PostgreSQL.
        // Npgsql requires DateTime values to carry an explicit DateTimeKind.
        // Specifying Utc here mirrors the legacy timestamp behaviour that
        // AppContext.SetSwitch("Npgsql.EnableLegacyTimestampBehavior", true)
        // provides in EF Core Npgsql; in EF6 we must apply it manually.
        // ------------------------------------------------------------------
