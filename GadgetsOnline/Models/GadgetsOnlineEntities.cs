...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // --- PostgreSQL: Category table and column mappings ---
            ...
            // --- PostgreSQL: Category relationships ---
            modelBuilder.Entity<Category>()
                .HasMany(c => c.Products)
                .WithRequired(p => p.Category)
                .HasForeignKey(p => p.CategoryId);

            // --- PostgreSQL: Product table and column mappings ---
            ...
            // --- PostgreSQL: Cart table and column mappings ---
            ...
            // --- PostgreSQL: Cart relationships ---
            modelBuilder.Entity<Cart>()
                .HasRequired(c => c.Product)
                .WithMany()
                .HasForeignKey(c => c.ProductId);

            // --- PostgreSQL: Order table and column mappings ---
            ...
            // --- PostgreSQL: Order relationships ---
            modelBuilder.Entity<Order>()
                .HasMany(o => o.OrderDetails)
                .WithRequired(od => od.Order)
                .HasForeignKey(od => od.OrderId);

            // --- PostgreSQL: OrderDetail table and column mappings ---
            ...
            // --- PostgreSQL: OrderDetail relationships ---
            modelBuilder.Entity<OrderDetail>()
