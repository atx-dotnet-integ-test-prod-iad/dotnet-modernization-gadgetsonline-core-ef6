...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // Configure relationships and PostgreSQL table/column mappings
            ...
            categoryConfig.HasMany(c => c.Products)
            ...
            cartConfig.HasRequired(c => c.Product)
                .WithMany()
            ...
            orderConfig.HasMany(o => o.OrderDetails)
            ...
            orderDetailConfig.HasRequired(od => od.Product)
                .WithMany()
