...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // Configure table mappings and column names: Category
            ...
            // Configure relationships: Category
            modelBuilder.Entity<Category>()
                .HasMany(c => c.Products)
                .WithRequired(p => p.Category)
                .HasForeignKey(p => p.CategoryId);

            // Configure table mappings and column names: Cart
            ...
            // Configure relationships: Cart
            modelBuilder.Entity<Cart>()
                .HasRequired(c => c.Product)
                .WithMany()
                .HasForeignKey(c => c.ProductId);

            // Configure table mappings and column names: Order
            ...
            // Configure relationships: Order
            modelBuilder.Entity<Order>()
                .HasMany(o => o.OrderDetails)
                .WithRequired(od => od.Order)
                .HasForeignKey(od => od.OrderId);

            // Configure table mappings and column names: OrderDetail
            ...
            // Configure relationships: OrderDetail
            modelBuilder.Entity<OrderDetail>()
                .HasRequired(od => od.Product)
                .WithMany()
                .HasForeignKey(od => od.ProductId);

            // Configure table mappings and column names: Product
