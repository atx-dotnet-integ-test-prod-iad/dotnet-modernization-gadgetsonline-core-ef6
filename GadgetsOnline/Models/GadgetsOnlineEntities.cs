...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime UTC compatibility for Npgsql (EF6)
        // Ensures all DateTime values are treated as UTC before persisting,
        // preventing "Cannot write DateTime with Kind=Local to PostgreSQL" errors.
        // -----------------------------------------------------------------------
