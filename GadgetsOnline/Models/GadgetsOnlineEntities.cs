...
namespace GadgetsOnline.Models
{
    ...
    /// Registers the Npgsql provider services, connection factory, and provider factory.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime compatibility: ensure all DateTime values are treated as UTC
        // so Npgsql does not throw on "timestamptz" columns expecting UTC kind.
        // -----------------------------------------------------------------------
