...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Product entity -> products table (schema: gadgetsonline_dbo)
            ...
            // Category entity -> categories table (schema: gadgetsonline_dbo)
            ...
            // Cart entity -> carts table (schema: gadgetsonline_dbo)
            ...
            // Order entity -> orders table (schema: gadgetsonline_dbo)
            ...
            // OrderDetail entity -> orderdetails table (schema: gadgetsonline_dbo)
