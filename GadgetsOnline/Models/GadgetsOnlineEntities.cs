...
{
    // PostgreSQL-specific configuration for EF6
    public class GadgetsOnlineEntitiesPostgreSqlConfiguration : DbConfiguration
    {
        ...
        {
            // EntityFramework6.Npgsql package automatically registers the Npgsql provider
            // No manual connection factory configuration needed
        }
    }
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // Configure Products entity with schema mapping
            ...
            // Configure Categories entity with schema mapping
            ...
            // Configure Carts entity with schema mapping
            ...
            // Configure Orders entity with schema mapping
            ...
            // Configure OrderDetails entity with schema mapping
