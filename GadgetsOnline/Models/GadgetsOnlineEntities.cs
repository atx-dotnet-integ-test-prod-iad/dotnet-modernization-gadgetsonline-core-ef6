...
namespace GadgetsOnline.Models
{
    ...
    // uses PostgreSQL instead of SQL Server without requiring app.config changes.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // -----------------------------------------------------------------
            // Category entity — table, column mappings and relationships
            // -----------------------------------------------------------------
            ...
            // -----------------------------------------------------------------
            // Cart entity — table, column mappings and relationships
            // -----------------------------------------------------------------
            ...
            // -----------------------------------------------------------------
            // Order entity — table, column mappings and relationships
            // -----------------------------------------------------------------
            ...
            // -----------------------------------------------------------------
            // OrderDetail entity — table, column mappings and relationships
            // -----------------------------------------------------------------
