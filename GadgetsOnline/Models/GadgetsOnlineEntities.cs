...
namespace GadgetsOnline.Models
{
    public class GadgetsOnlineEntitiesPostgreSqlConfiguration : DbConfiguration
    {
        ...
        {
            // EntityFramework6.Npgsql automatically registers the connection factory
            // No explicit SetDefaultConnectionFactory call needed
        }
    }
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // Configure table and column mappings for Products
            ...
            // Configure table and column mappings for Categories
            ...
            // Configure table and column mappings for Carts
            ...
            // Configure table and column mappings for Orders
            ...
            // Configure table and column mappings for OrderDetails
