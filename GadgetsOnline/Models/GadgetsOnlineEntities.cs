...
{
    /// <summary>
    /// EF6 PostgreSQL DbConfiguration for GadgetsOnlineEntities.
    /// Registers Npgsql as the provider services implementation and connection factory.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime UTC compatibility: ensures all DateTime values saved to
        // PostgreSQL carry DateTimeKind.Utc (Npgsql requirement).
        // -----------------------------------------------------------------------
        ...
        {
            // -----------------------------------------------------------------------
            // Table & column mappings — PostgreSQL target schema: gadgetsonline_dbo
            // All names are lowercased per PostgreSQL naming conventions.
            // -----------------------------------------------------------------------
