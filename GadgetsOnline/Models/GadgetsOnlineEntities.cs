...
namespace GadgetsOnline.Models
{
    ...
    /// Registers Npgsql as the database provider and connection factory.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC compatibility: ensures all DateTime values written to
        // PostgreSQL carry DateTimeKind.Utc, which Npgsql requires for
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // -----------------------------------------------------------------------
            // Category entity — table + column mappings + relationships
            // -----------------------------------------------------------------------
            ...
            // -----------------------------------------------------------------------
            // Cart entity — table + column mappings + relationships
            // -----------------------------------------------------------------------
            ...
            // -----------------------------------------------------------------------
            // Order entity — table + column mappings + relationships
            // -----------------------------------------------------------------------
            ...
            // -----------------------------------------------------------------------
            // OrderDetail entity — table + column mappings + relationships
            // -----------------------------------------------------------------------
