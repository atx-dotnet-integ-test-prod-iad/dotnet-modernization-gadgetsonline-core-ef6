...
{
    /// <summary>
    /// EF6 PostgreSQL configuration class.
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // ---------------------------------------------------------------------------
            // Entity table and column mappings (PostgreSQL: schema=gadgetsonline_dbo)
            // ---------------------------------------------------------------------------
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC fix for EF6 + PostgreSQL (Npgsql requires UTC DateTimeKind)
        // ---------------------------------------------------------------------------
