...
namespace GadgetsOnline.Models
{
    ...
    /// EF6 can resolve the Npgsql driver at runtime without a config-file entry.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime compatibility: PostgreSQL requires UTC-flagged DateTime values.
        // FixDateTimeKinds() re-stamps every Added/Modified DateTime to DateTimeKind.Utc
        // before the round-trip to Npgsql, preventing "Cannot write DateTime with Kind=
        // Local/Unspecified to PostgreSQL type 'timestamp with time zone'" errors.
        // ---------------------------------------------------------------------------
