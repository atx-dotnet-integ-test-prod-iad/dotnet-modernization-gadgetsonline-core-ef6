...
{
    // PostgreSQL/Npgsql provider configuration for EF6
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // EF6 DateTime compatibility: ensure all DateTime values are treated as UTC
        // to avoid Npgsql "timestamp with time zone" kind mismatch errors
