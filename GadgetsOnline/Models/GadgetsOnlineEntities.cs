...
namespace GadgetsOnline.Models
{
    ...
    // EF6 knows how to talk to PostgreSQL when the app.config connection string
    // uses the "Npgsql" provider invariant name.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC fix: ensures all DateTime values written to PostgreSQL carry
        // DateTimeKind.Utc, which Npgsql requires for timestamptz columns.
        // ---------------------------------------------------------------------------
