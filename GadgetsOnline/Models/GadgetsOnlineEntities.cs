...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // -------------------------------------------------------
            // Category entity: table and column mappings + relationships
            // -------------------------------------------------------
            ...
            // -------------------------------------------------------
            // Cart entity: table and column mappings + relationships
            // -------------------------------------------------------
            ...
            // -------------------------------------------------------
            // Order entity: table and column mappings + relationships
            // -------------------------------------------------------
            ...
            // -------------------------------------------------------
            // OrderDetail entity: table and column mappings + relationships
            // -------------------------------------------------------
