...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -------------------------------------------------------------------
        // DateTime UTC fix — ensures all DateTime values are stored/read as
        // UTC so that Npgsql does not throw on ambiguous DateTimeKind.
        // -------------------------------------------------------------------
        ...
        {
            // ---------------------------------------------------------------
            // Product — schema: gadgetsonline_dbo, table: products
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // Category — schema: gadgetsonline_dbo, table: categories
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // Cart — schema: gadgetsonline_dbo, table: carts
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // Order — schema: gadgetsonline_dbo, table: orders
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // OrderDetail — schema: gadgetsonline_dbo, table: orderdetails
            // ---------------------------------------------------------------
