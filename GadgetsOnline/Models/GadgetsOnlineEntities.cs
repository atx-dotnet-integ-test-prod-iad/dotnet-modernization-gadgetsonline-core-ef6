...
namespace GadgetsOnline.Models
{
    ...
    // Registers Npgsql as the ADO.NET provider and default connection factory so
    // that Entity Framework 6 uses PostgreSQL instead of SQL Server.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ------------------------------------------------------------------
        // DateTime UTC compatibility shim for PostgreSQL / Npgsql.
        // Npgsql rejects DateTime values whose Kind is Unspecified when writing
        // to a 'timestamp with time zone' column.  These overrides normalise
        // every DateTime tracked by the change-tracker to DateTimeKind.Utc
        // before the INSERT / UPDATE is sent to the database.
        // ------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Columns: lowercase names matching the migrated PostgreSQL schema
            // ----------------------------------------------------------------
