...
namespace GadgetsOnline.Models
{
    ...
    /// Registers Npgsql services so EF6 knows how to talk to PostgreSQL.
    /// </summary>
    public class GadgetsOnlineEntitiesPostgreSqlConfiguration : DbConfiguration
    {
        ...
        {
            SetProviderServices("System.Data.Npgsql", NpgsqlServices.Instance);
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------
        // DateTime UTC compatibility fix for PostgreSQL (EF6)
        // Npgsql requires DateTime values to carry DateTimeKind.Utc when
        // writing to timestamptz columns; this ensures all Added/Modified
        // entities have their DateTime properties normalised before saving.
        // ---------------------------------------------------------------
        ...
        {
            // ---------------------------------------------------------------
            // Schema + column name mappings (PostgreSQL target: gadgetsonline_dbo)
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // Relationship configuration (preserved from original)
            // ---------------------------------------------------------------
