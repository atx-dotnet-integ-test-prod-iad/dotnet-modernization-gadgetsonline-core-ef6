...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Configure table and column mappings for Category + relationships
            ...
            // Configure table and column mappings for Cart + relationships
            ...
            // Configure table and column mappings for Order + relationships
            ...
            // Configure table and column mappings for OrderDetail + relationships
