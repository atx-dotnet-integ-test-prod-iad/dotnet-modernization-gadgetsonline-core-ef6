...
namespace GadgetsOnline.Models
{
    ...
    // resolves the correct driver without requiring a machine-level registration.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime compatibility: normalise all DateTime values to UTC before
        // sending them to PostgreSQL, which requires timestamptz to be UTC.
        // -----------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // (no relationship originating from Product; FK back-references are
            //  configured on the owning side below)
            // -------------------------------------------------------------------
