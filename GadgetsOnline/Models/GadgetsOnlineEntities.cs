...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        private void FixDateTimeKinds()
        {
            ...
            foreach (var entry in entries)
            {
                foreach (var property in entry.CurrentValues.PropertyNames)
                {
                    ...
                    if (value is System.DateTime dateTime && dateTime.Kind != System.DateTimeKind.Utc)
                    {
                        entry.CurrentValues[property] = System.DateTime.SpecifyKind(dateTime, System.DateTimeKind.Utc);
                    }
                }
            }
        }
        ...
        {
            // Configure relationships and table/column mappings for Product
            ...
            // Configure relationships and table/column mappings for Category
            ...
            // Configure relationships and table/column mappings for Cart
            ...
            // Configure relationships and table/column mappings for Order
            ...
            // Configure relationships and table/column mappings for OrderDetail
