...
namespace GadgetsOnline.Models
{
    ...
    /// Registers Npgsql as the database provider via DbConfiguration.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -------------------------------------------------------------------
        // DateTime UTC fix – ensures all DateTime values written to
        // PostgreSQL carry DateTimeKind.Utc (required by Npgsql).
        // -------------------------------------------------------------------
