...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // ------------------------------------
            // Product entity: table + column names
            // ------------------------------------
            ...
            // ------------------------------------
            // Category entity: table + column names
            // ------------------------------------
            ...
            // ------------------------------------
            // Cart entity: table + column names
            // ------------------------------------
            ...
            // ------------------------------------
            // Order entity: table + column names
            // ------------------------------------
            ...
            // ------------------------------------
            // OrderDetail entity: table + column names
            // ------------------------------------
            ...
            // ------------------------------------
            // Relationships (preserved unchanged)
            // ------------------------------------
            modelBuilder.Entity<Category>()
