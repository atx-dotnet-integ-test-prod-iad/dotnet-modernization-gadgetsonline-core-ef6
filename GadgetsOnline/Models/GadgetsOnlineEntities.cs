...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // -------------------------------------------------------
            // PostgreSQL table and column mappings — Product
            // -------------------------------------------------------
            ...
            // -------------------------------------------------------
            // PostgreSQL table and column mappings — Category
            // -------------------------------------------------------
            modelBuilder.Entity<Category>()
            ...
            // -------------------------------------------------------
            // PostgreSQL table and column mappings — Cart
            // -------------------------------------------------------
            modelBuilder.Entity<Cart>()
            ...
            // -------------------------------------------------------
            // PostgreSQL table and column mappings — Order
            // -------------------------------------------------------
            modelBuilder.Entity<Order>()
            ...
            // -------------------------------------------------------
            // PostgreSQL table and column mappings — OrderDetail
            // -------------------------------------------------------
            modelBuilder.Entity<OrderDetail>()
