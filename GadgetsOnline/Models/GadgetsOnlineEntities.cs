...
{
    // ---------------------------------------------------------------------------
    // EF6 PostgreSQL DbConfiguration
    // Discovered automatically by EF6 because it lives in the same assembly.
    // The [DbConfigurationType] attribute on GadgetsOnlineEntities also pins it
    // explicitly, so both discovery paths are satisfied.
    // ---------------------------------------------------------------------------
    ...
    {
        // Default constructor — reads the connection string named
        // "GadgetsOnlineEntities" from Web.config / app.config.
        ...
        // -----------------------------------------------------------------
        // DateTime UTC fix — required for Npgsql timestamptz round-trips
        // -----------------------------------------------------------------
