...
{
    // EF6 PostgreSQL DbConfiguration — registers Npgsql as the database provider.
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // EF6 DateTime compatibility: Npgsql requires DateTime values stored in the
        // database to carry DateTimeKind.Utc.  These overrides normalise any Added /
        // Modified entities before the SQL is sent to PostgreSQL.
        // ---------------------------------------------------------------------------
