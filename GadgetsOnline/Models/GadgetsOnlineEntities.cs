...
namespace GadgetsOnline.Models
{
    ...
    /// Registers the Npgsql provider services and default connection factory
    /// so that EF6 can communicate with a PostgreSQL database.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC compatibility for PostgreSQL.
        // Npgsql requires all DateTime values stored as TIMESTAMP WITH TIME ZONE to
        // carry DateTimeKind.Utc.  These overrides normalise every Added/Modified
        // DateTime property to Utc before hitting the database.
        // ---------------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Generated from core_get_entities_for_fluent_api_by_dbcontext results.
            // -----------------------------------------------------------------------
            ...
            // -----------------------------------------------------------------------
            // Relationships — preserved exactly from original source
            // -----------------------------------------------------------------------
