...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -------------------------------------------------------------------------
        // EF6 DateTime UTC fix — ensures all DateTime values sent to PostgreSQL
        // carry DateTimeKind.Utc, which Npgsql requires for timestamptz columns.
        // -------------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // -----------------------------------------------------------------
            // Table + column name mappings (MSSQL PascalCase -> PostgreSQL lower)
            // -----------------------------------------------------------------
