...
{
    /// <summary>
    /// EF6 DbConfiguration for PostgreSQL/Npgsql provider.
    /// Registered automatically by EF6 via [DbConfigurationType] on GadgetsOnlineEntities.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------
        // DateTime compatibility: ensure all DateTime values sent to
        // Npgsql carry DateTimeKind.Utc (Npgsql rejects Unspecified kind
