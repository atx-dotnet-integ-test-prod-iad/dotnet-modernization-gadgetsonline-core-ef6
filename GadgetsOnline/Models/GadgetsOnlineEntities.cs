...
namespace GadgetsOnline.Models
{
    ...
    // Entity Framework 6 uses PostgreSQL instead of SQL Server.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime UTC compatibility fix for PostgreSQL.
        // Npgsql requires DateTime values to carry DateTimeKind.Utc when stored
        // in "timestamp with time zone" columns.  The helpers below normalise
        // every DateTime being written so that EF6 never sends an Unspecified-
        // or Local-kind value to the driver.
        // -----------------------------------------------------------------------
        ...
        {
            // -------------------------------------------------------------------
            // Table + column name mappings for PostgreSQL (schema: gadgetsonline_dbo)
            // Column names are lowercased to match the PostgreSQL target schema.
            // -------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------
            // Relationship configurations (preserved unchanged from original)
            // -------------------------------------------------------------------
            modelBuilder.Entity<Category>()
