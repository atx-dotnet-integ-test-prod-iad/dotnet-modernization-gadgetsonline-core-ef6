...
namespace GadgetsOnline.Models
{
    ...
    // Registers the Npgsql provider services, connection factory, and ADO.NET
    // provider factory so that EF6 resolves all database operations through Npgsql.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime UTC fix for EF6 + Npgsql:
        // Npgsql requires DateTime values to carry DateTimeKind.Utc when writing
        // to timestamptz columns.  These overrides normalise all DateTime values
        // to Utc before the underlying SaveChanges call is issued.
        // -----------------------------------------------------------------------
        ...
        {
            // -------------------------------------------------------------------
            // Schema + column mappings  (schema: gadgetsonline_dbo)
            // -------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------
            // Relationship configurations (unchanged from original)
            // -------------------------------------------------------------------
