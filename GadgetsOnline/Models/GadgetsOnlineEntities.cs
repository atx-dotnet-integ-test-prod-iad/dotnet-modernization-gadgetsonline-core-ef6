...
{
    /// <summary>
    /// EF6 PostgreSQL configuration class — registers the Npgsql provider
    /// and connection factory so EF6 uses PostgreSQL for all operations.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ----------------------------------------------------------------
        // DateTime compatibility: normalise all DateTime values to UTC
        // before they are sent to PostgreSQL (which is timezone-aware).
        // ----------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Category -> Products relationship (preserved)
            modelBuilder.Entity<Category>()
            ...
            // Cart -> Product relationship (preserved)
            modelBuilder.Entity<Cart>()
            ...
            // Order -> OrderDetails relationship (preserved)
            modelBuilder.Entity<Order>()
            ...
            // OrderDetail -> Product relationship (preserved)
            modelBuilder.Entity<OrderDetail>()
