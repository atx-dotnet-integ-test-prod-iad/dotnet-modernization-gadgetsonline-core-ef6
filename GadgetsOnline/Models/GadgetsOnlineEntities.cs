...
{
    // EF6 PostgreSQL provider configuration — registers Npgsql as the
    // ADO.NET provider and connection factory for this DbContext.
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime compatibility — ensures DateTime values sent to Npgsql are treated
        // as UTC, matching Npgsql's legacy timestamp behaviour expected by EF6 models.
        // ---------------------------------------------------------------------------
