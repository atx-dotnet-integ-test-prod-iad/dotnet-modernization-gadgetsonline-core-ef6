...
namespace GadgetsOnline.Models
{
    ...
    // EF6 resolves the correct driver at runtime without any app.config changes.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------
        // DateTime UTC normalization for PostgreSQL
        // Npgsql requires DateTime values stored as timestamptz to have
        // DateTimeKind.Utc.  These overrides fix any Unspecified/Local values
        // before they reach the database driver.
        // ---------------------------------------------------------------------
