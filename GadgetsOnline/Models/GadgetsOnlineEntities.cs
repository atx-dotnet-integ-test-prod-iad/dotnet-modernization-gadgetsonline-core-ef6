...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------
        // DateTime UTC fix for PostgreSQL — Npgsql requires all DateTime values
        // to carry DateTimeKind.Utc when writing to timestamptz columns.
        // ---------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Schema: gadgetsonline_dbo  Table: products
            // -----------------------------------------------------------------
            ...
            // Schema: gadgetsonline_dbo  Table: categories
            // -----------------------------------------------------------------
            ...
            // Schema: gadgetsonline_dbo  Table: carts
            // -----------------------------------------------------------------
            ...
            // Schema: gadgetsonline_dbo  Table: orders
            // -----------------------------------------------------------------
            ...
            // Schema: gadgetsonline_dbo  Table: orderdetails
            // -----------------------------------------------------------------
