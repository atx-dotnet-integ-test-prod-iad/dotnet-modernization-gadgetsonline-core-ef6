...
namespace GadgetsOnline.Models
{
    ...
    // EF6 knows how to talk to PostgreSQL without requiring a machine-level
    // install of the provider.  The [DbConfigurationType] attribute below
    // links this class to the GadgetsOnlineEntities context automatically.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------
        // DateTime UTC normalisation for PostgreSQL
        // Npgsql requires all DateTime values stored as TIMESTAMP WITH TIME ZONE
        // to carry DateTimeKind.Utc.  These overrides fix any Unspecified/Local
        // values before they are sent to the database.
        // ---------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // -----------------------------------------------------------------
            // Relationships (preserved unchanged from original)
            // -----------------------------------------------------------------
            modelBuilder.Entity<Category>()
