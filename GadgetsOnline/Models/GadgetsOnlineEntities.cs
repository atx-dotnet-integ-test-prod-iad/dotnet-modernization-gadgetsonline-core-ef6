...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // -------------------------------------------------------------------
            // Entity table and column mappings for PostgreSQL (schema: gadgetsonline_dbo)
            // -------------------------------------------------------------------
        ...
        // -------------------------------------------------------------------
        // EF6 DateTime compatibility: ensure all DateTime values sent to
        // PostgreSQL carry DateTimeKind.Utc to avoid Npgsql type errors.
        // -------------------------------------------------------------------
