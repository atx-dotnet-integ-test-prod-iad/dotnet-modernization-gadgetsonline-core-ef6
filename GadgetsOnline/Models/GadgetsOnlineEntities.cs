...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // Configure table and column mappings: Product -> products (gadgetsonline_dbo)
            ...
            // Configure table and column mappings: Category -> categories (gadgetsonline_dbo)
            ...
            // Configure table and column mappings: Cart -> carts (gadgetsonline_dbo)
            ...
            // Configure table and column mappings: Order -> orders (gadgetsonline_dbo)
            ...
            // Configure table and column mappings: OrderDetail -> orderdetails (gadgetsonline_dbo)
