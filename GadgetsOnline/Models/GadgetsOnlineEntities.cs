...
namespace GadgetsOnline.Models
{
    ...
    // Registers Npgsql as the ADO.NET provider for EF6.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // EF6 DateTime UTC fix — ensures all DateTime values are treated as UTC
        // when persisted to PostgreSQL via Npgsql (which is strict about DateTimeKind).
        // ---------------------------------------------------------------------------
        ...
        {
            // ---------------------------------------------------------------------------
            // Default schema — maps all unmapped tables to the target PostgreSQL schema.
            // ---------------------------------------------------------------------------
            modelBuilder.HasDefaultSchema("gadgetsonline_dbo");

            // ---------------------------------------------------------------------------
            // Table and column mappings — source of truth from schema migration analysis.
            // Target schema: gadgetsonline_dbo  |  All column names lowercased.
            // EF6 requires chained method calls; lambda-block overloads are EF Core only.
            // ---------------------------------------------------------------------------
