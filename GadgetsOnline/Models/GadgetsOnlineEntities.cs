...
{
    // ---------------------------------------------------------------------------
    // PostgreSQL provider configuration for EF6 + EntityFramework6.Npgsql
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ------------------------------------------------------------------
        // SaveChanges overrides — fixes DateTime.Kind for Npgsql timestamp
        // compatibility (Npgsql requires DateTimeKind.Utc for timestamptz).
        // ------------------------------------------------------------------
