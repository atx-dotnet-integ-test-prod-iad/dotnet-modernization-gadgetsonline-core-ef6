...
namespace GadgetsOnline.Models
{
    ...
    // EF6 knows how to talk to PostgreSQL instead of SQL Server.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql requires all DateTime values stored as timestamptz to carry
        // DateTimeKind.Utc.  The helpers below normalise every DateTime being
        // written so that existing code that passes Unspecified/Local values
