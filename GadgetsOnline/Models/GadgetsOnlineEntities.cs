...
namespace GadgetsOnline.Models
{
    ...
    // Replaces SQL Server provider registration previously handled via app.config
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------
        // DateTime UTC fix for PostgreSQL timestamp compatibility
        // Ensures all DateTime values are marked as UTC before persistence
        // -----------------------------------------------------------------
