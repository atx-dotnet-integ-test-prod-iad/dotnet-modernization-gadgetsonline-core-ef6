...
namespace GadgetsOnline.Models
{
    ...
    // Registers Npgsql as the database provider for this DbContext.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC compatibility fix for PostgreSQL / Npgsql.
        // Ensures all DateTime values are stored with UTC kind so Npgsql does not
        // throw "Cannot write DateTime with Kind=Unspecified" at runtime.
        // ---------------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // TargetTable: gadgetsonline_dbo.products
            // -----------------------------------------------------------------------
            ...
            // TargetTable: gadgetsonline_dbo.categories
            // -----------------------------------------------------------------------
            ...
            // -----------------------------------------------------------------------
            // Cart — table & column mappings
            // TargetTable: gadgetsonline_dbo.carts
            // -----------------------------------------------------------------------
            ...
            // TargetTable: gadgetsonline_dbo.orders
            // -----------------------------------------------------------------------
            ...
            // -----------------------------------------------------------------------
            // OrderDetail — table & column mappings
            // TargetTable: gadgetsonline_dbo.orderdetails
            // -----------------------------------------------------------------------
